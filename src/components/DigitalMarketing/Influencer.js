...
const Influencer = () => {
  return (
    <section className="we-are-area h-screen flex items-center bg-black text-white">
        ...
        <div>
          <div className="we-are-content">
            <div className="section-title">
              <h2 className="pb-12 primary-heading text-4xl md:text-5xl">
                THE <span className="highlight">INFLUENCER</span>
              </h2>
            </div>
            <p className="app__text text-lg md:text-xl">
              Social media has all kinds of content these days: The most popular
              of them are the entertainment ones.
            </p>
            <ul
              role="list"
              className="mt-8 space-y-8 app__text text-lg md:text-xl"
            >
