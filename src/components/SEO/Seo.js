...
const Seo = () => {
  return (
    <section>
      <div className="app__container relative isolate overflow-hidden bg-black px-6 pt-12 pb-24 sm:pt-12 sm:pb-32 lg:overflow-visible lg:px-0">
          ...
          <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
            <div className="lg:pr-4">
              <div className="lg:max-w-lg">
                <p className="text-base font-semibold leading-7 text-white">Search Engine Optimization</p>
                <h1 className="mt-2 primary-heading text-white">What is Search Engine Optimization?</h1>
                <p className="mt-6 app__text text-white">
          ...
          <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
            <div className="lg:pr-4">
              <div className="max-w-xl lg:max-w-lg">
                <h2 className="mt-4 text-2xl font-bold tracking-tight text-white">The perfect SEO strategy for your business</h2>
                <p className="mt-8 app__text text-white">
