...
const SeoServices = () => {
  ...
  return (
    <section className="py-16 md:py-32 bg-black">
      <div className="app__container text-white">
        <div className="row">
          <div className="pb-12 text-center">
            ...
            <p className='app__text'>Keyword Planning: A clear keyword strategy means pages will not compete.<br/>
              With one another for the same search terms. Each page will have a specific purpose.
            </p>
          </div>
        </div>
            ...
            <motion.div variants={items} key={key}>
              <div className={`common-single-card flex flex-col py-12 px-8 ${service.hoverBg}`}>
                ...
                <div className="text-center text-black">
                  ...
                  <p className='text-base text-black'>{service.desc}</p>
                </div>
              </div>
            </motion.div>
          ))}
            ...
            <motion.div variants={items} key={key}>
              <div className={`common-single-card flex flex-col py-12 px-8 ${benefit.hoverBg}`}>
                ...
                <div className="text-center text-black">
                  ...
                  <p className='text-base text-black'>{benefit.desc}</p>
                </div>
              </div>
            </motion.div>
          ))}
