...
const Powerful = () => {
  return (
    <section className="we-are-area py-16 md:py-32 flex items-center bg-black text-white">
          ...
          <div className="we-are-content">
            ...
            <ul role="list" className="mt-8 space-y-8 text-gray-200">
              <li className="flex gap-x-3">
                ...
                <span className='app__text'>Fully Responsive Website</span>
              </li>
              <li className="flex gap-x-3">
                <CheckCircleIcon className="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" />
                <span className='app__text'>100% attractive website development</span>
              </li>
              <li className="flex gap-x-3">
                <CheckCircleIcon className="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" />
                <span className='app__text'>Clean and modern UI design</span>
              </li>
              <li className="flex gap-x-3">
                <CheckCircleIcon className="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" />
                <span className='app__text'>Only built using the latest technologies</span>
              </li>
            </ul>
          </div>
        </div>
