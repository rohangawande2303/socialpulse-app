...
export const WebEngaging = () => {
  return (
    <section className="engaging-business py-16 md:py-32 bg-black text-white">
            ...
            <div className="engaging-business-heading text-center pb-50">
              <div className="section-title pb-6">
                <h2 className="primary-heading">
                  Get a website that Engage Business Decisions for Revenue{" "}
                  <span className="highlight">Growth</span>
                </h2>
              </div>
              <p className="app__text">
                For the process of dusting alone, trained professionals are
                required who hear about the specifications of your products,
                functions, and design and then create a relatable but still very
                creative promotion where your product shines, and displays at
                its best. We work in a professional manner, Our various team
              ...
              <div className="engaging-top">
                ...
                <div className="engaging-card-two">
                  <div className="purple-hover engaging-single-card flex items-center gap-4 common-single-card">
                    ...
                    <div className="h4-card-content">
                      <div className="card-title">
                        <h3 className="font-bold text-black">Modern UI UX</h3>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="engaging-btm">
                <div className="engaging-card-three">
                  <div className="paste-hover engaging-single-card flex items-center gap-4 common-single-card">
                    ...
                    <div className="h4-card-content">
                      <div className="card-title">
                        <h3 className="font-bold text-black">Quality Testing Team</h3>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="engaging-card-four">
                  <div className="pink-hover engaging-single-card flex items-center gap-4 common-single-card">
                    ...
                    <div className="h4-card-content">
                      <div className="card-title">
                        <h3 className="font-bold text-black">Delivery Team</h3>
                      </div>
                    </div>
                  </div>
                </div>
