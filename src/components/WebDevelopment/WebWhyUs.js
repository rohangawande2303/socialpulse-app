...
const WebWhyUs = () => {
  return (
    <section className="we-are-area py-16 md:py-32 flex items-center bg-black text-white relative">
      <div className="app__container grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="my-auto">
          <div className="we-are-content">
            ...
            <p className='app__text'>Kids believe that the turtle was hardworking, but the truth is that if the rabbit had not been distracted, the turtle would have lost the race. You alone, looking after investment and creativity along with your business, will make you the distracted rabbit. WebDev Private Limited comes into the story now, follows the rabbit through the race, and then reminds him of his self-worth and power. The rabbit stays the fastest and smartest in the jungle!</p>
